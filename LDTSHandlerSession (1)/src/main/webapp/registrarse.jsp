...
<%
  ...
  if (usuario != null && contrasenia != null) {
    beanDB db = new beanDB();  // Crear instancia de la clase de conexión a la base de datos
    try {
      db.conectarBD();  // Conectar a la base de datos
     ...
     System.out.println("Usuario registrado exitosamente!");
      ...
      db.desconectarBD();  // Asegurarse de cerrar la conexión
    }
  } else {
